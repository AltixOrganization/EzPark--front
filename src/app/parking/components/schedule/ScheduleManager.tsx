...
const ScheduleManager: React.FC<ScheduleManagerProps> = ({
    ...
    const confirmDelete = async () => {
        if (!deletingSchedule || !deletingSchedule.id) return;
                        ...
                        <div className="text-center">
                            ...
                            <div className="flex space-x-3">
                                <button
                                    ...
                                    disabled={deleting}
                                    className="flex-1 bg-gray-200 text-gray-800 py-2 px-4 rounded-md hover:bg-gray-300 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Cancelar
                                </button>
                                <button
                                    ...
                                    disabled={deleting}
                                    className="flex-1 bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                                >
                                    {deleting ? (
                                        <>
